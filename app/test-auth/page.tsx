  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 p-8">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl p-8">
        ...
        {/* Message */}
        {message && (
          <div className="bg-chain/5 border-2 border-chain/30 rounded-xl p-3 mb-4">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border-2 border-gray-300 rounded-xl focus:border-chain focus:outline-none"
