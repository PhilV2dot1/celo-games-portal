      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <button
              onClick={() => router.back()}
              className="text-gray-700 hover:text-gray-900 font-semibold flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-xl border-2 border-gray-300 hover:border-chain transition-all"
            >
              ← Retour
            </button>
            <button
            ...
            <input
              ...
              className={`w-full px-4 py-2 border-2 rounded-xl focus:outline-none transition-all ${
                displayNameError
                  ...
                  : 'border-gray-300 focus:border-chain'
              }`}
            />
