        ...
        <div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-xl border-2 border-gray-300 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-chain transition-all"
                disabled={loading}
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-chain to-chain hover:brightness-110 disabled:from-gray-300 disabled:to-gray-400 text-gray-900 font-bold py-3 rounded-xl transition-all disabled:cursor-not-allowed shadow-lg"
            >
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/" className="text-chain hover:brightness-110 font-semibold">
                Se connecter
              </Link>
            </p>
            <p className="text-sm text-gray-600">
