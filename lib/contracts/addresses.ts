...
export type SupportedChainId = typeof celo.id | typeof base.id | typeof megaeth.id;
export type SupportedChain = 'celo' | 'base' | 'megaeth';
...
export const SUPPORTED_CHAIN_IDS: number[] = [celo.id, base.id, megaeth.id];
