  ...
  en: {
    ...
    games: {
      ...
      coinflip: {
        ...
        rule4: 'Chain 3+ wins to unlock Cash Out — only one on-chain tx per series!',
        heads: 'Heads',
        tails: 'Tails',
        tapToFlip: 'Choose a side to flip the coin',
        flipping: 'The coin is spinning...',
        waitingTx: '⏳ Waiting for blockchain confirmation...',
        waitingStart: '⏳ Sign to start your on-chain series…',
        waitingEnd: '⛓️ Recording series on-chain…',
        flipAgain: 'Play Again',
        cashOut: 'Cash Out series',
        continueOrCashOut: 'Continue your streak or cash out!',
        win: 'Well played! 🎉',
        lose: 'Bad luck...',
        streak: 'Streak',
  ...
  fr: {
    ...
    games: {
      ...
      coinflip: {
        ...
        rule4: 'Enchaîne 3+ victoires pour débloquer le Cash Out — une seule tx on-chain par série !',
        heads: 'Pile',
        tails: 'Face',
        tapToFlip: 'Choisis un côté pour lancer la pièce',
        flipping: 'La pièce tourne...',
        waitingTx: '⏳ En attente de confirmation blockchain...',
        waitingStart: '⏳ Signe pour démarrer ta série on-chain…',
        waitingEnd: '⛓️ Enregistrement de la série on-chain…',
        flipAgain: 'Rejouer',
        cashOut: 'Encaisser la série',
        continueOrCashOut: 'Continue ta série ou encaisse !',
        win: 'Bien joué ! 🎉',
        lose: 'Pas de chance...',
        streak: 'Série',
        bestStreak: 'Record',
