      ...
      {showPlayButtons && (
        <>
          <button
            onClick={onHit}
            disabled={disabled}
            className="px-6 sm:px-8 py-3 sm:py-4 bg-white/90 dark:bg-gray-700 hover:bg-white dark:hover:bg-gray-600 text-gray-900 dark:text-white rounded-xl font-bold text-base sm:text-lg shadow-lg border-2 border-gray-300 dark:border-gray-500 hover:border-chain disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 active:scale-95 min-w-[100px] sm:min-w-[120px]"
          >
